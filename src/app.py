...
activities = {
    ...
    "Art Club": {
        ...
        "max_participants": 18,
        "participants": ["sophia.art@mergington.edu", "mia@mergington.edu"]
    },
    "Drama Society": {
        "description": "Acting workshops and full-scale stage productions",
        "schedule": "Fridays, 4:00 PM - 6:30 PM (plus weekend rehearsals before shows)",
        "max_participants": 25,
